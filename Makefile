...
#    Updated: 2024/02/08 08:41:07 by bebrandt         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FDF_SRCS	=	fdf.c input_validation.c init_struct.c map.c matrix.c point.c event.c draw.c  safe_free.c check_malloc.c cleanup.c test_function.c
